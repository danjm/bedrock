...
;(function(Mozilla, $) {
    ...
    var showV1 = Math.random() >= 0.5;

    // hack to force either nav version for testing
    // TODO: remove
    var href = window.location.href;

    if (href.indexOf('?v1=') !== -1) {
        showV1 = true;
    } else if (href.indexOf('?v2=') !== -1) {
        showV1 = false;
    }
    ...
    Mozilla.FxFamilyNavV2 = (function() {
        ...
        var _enableDesktop = function() {
            ...
            $primaryLis.on('mouseover', function() {
                $primaryLinks.blur();
        ...
        var _init = function(configBak) {
            ...
            switch (configBak.primaryId) {
                ...
                default:
                    ...
                    config.subId = configBak.subId || 'index';
            ...
            currentNavId = currentSubNavId = config.primaryId;
        ...
        var _initGA = function() {
            ...
            $subNavs.on('click', 'a', function(e) {
                ...
                if (e.metaKey || e.ctrlKey) {
                    window.gaTrack(['_trackEvent', 'Fx Family Nav V2 Interactions', trackName, parentName[1]]);
                } else {
                    e.preventDefault();
                    window.gaTrack(['_trackEvent', 'Fx Family Nav V2 Interactions', trackName, parentName[1]], function() {
